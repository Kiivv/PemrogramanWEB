 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">SELAMAT DATANG DI PETSHOP KAMI</h1>
            <p class="lead fw-normal text-white-50 mb-0">selamat berbelanja dan belanja yang banyak yaaa</p>
        </div>
    </div>
</header>
<!-- Section-->
